...
namespace PhotoEnhancer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            mainForm.AddFilter(new PixelFilter<HSLLighteningParameters>(
                "Осветление/затемнение по HSL",
                (pixel, parameters) => Convertors.HSLToRGB(pixel.H, pixel.S, pixel.L * parameters.Coefficient)));
